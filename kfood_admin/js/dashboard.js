...
function updateDashboardUI(data) {
    ...
    document.getElementById('todayRevenue').textContent = formatCurrency(stats.revenue.today_revenue);
    document.getElementById('monthRevenue').textContent = formatCurrency(stats.revenue.month_revenue);
    document.getElementById('avgOrderValue').textContent = formatCurrency(stats.revenue.avg_order_value);
    ...
    document.getElementById('availableItems').textContent = stats.inventory.available_items;
