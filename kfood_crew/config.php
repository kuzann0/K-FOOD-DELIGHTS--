<?php
/**
 * Main configuration file for K-Food Crew Module
 */
...
define('MODULE_NAME', 'K-Food Crew');
define('BASE_URL', '/kfood/kfood_crew');
define('UPLOAD_PATH', __DIR__ . '/uploads');

// WebSocket Configuration
define('WS_HOST', 'localhost');
define('WS_PORT', '8080');
define('WS_PATH', '/kfood');
